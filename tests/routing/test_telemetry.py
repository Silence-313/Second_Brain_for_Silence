...
class TestRouterTelemetry:
    def test_record_routing(self) -> None:
        ...
        rt.record_routing(
            RoutingRecord(
                query="test", selected_tool="web_search", confidence=0.8, execution_success=True
            )
        )
    ...
    def test_get_all_metrics(self) -> None:
        ...
        rt.record_routing(
            RoutingRecord(
                query="test", selected_tool="test_tool", confidence=0.5, execution_success=True
            )
        )
    ...
    def test_serialize_deserialize(self) -> None:
        ...
        rt.record_routing(
            RoutingRecord(
                query="q", selected_tool="web_search", confidence=0.7, execution_success=True
            )
        )
